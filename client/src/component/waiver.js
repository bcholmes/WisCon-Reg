        ...
        return (
            <Modal show={this.state.show} onHide={this.handleClose}>
                ...
                <Modal.Body>
                    ...
                    <p>We are guided by our Statement of Principles, which can be found here: http://wiscon.net/policies/principles/.</p>
                </Modal.Body>
                <Modal.Footer>
                    <Button variant="link" onClick={this.handleClose}>
                        Cancel
                    </Button>
                    <Button variant="primary" onClick={this.handleClose} disabled="true">
                        Checkout
                    </Button>
                </Modal.Footer>
            </Modal>
